...
#ifndef mistcoin_MAIN_H
#define mistcoin_MAIN_H
...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 5 * CENT;	// 3% annual interest
...
static const uint256 hashGenesisBlock("0x000004b36930dbeeb9fcc213d864bb69e6261918b3f05310a971cb49d04c8479");
...
public:
    ...
    {
        // mistcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of mistcoins spent by this transaction.
    ...
    /** Amount of mistcoins coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // mistcoin: get transaction coin age
...
public:
    ...
    // mistcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // mistcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // mistcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // mistcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // mistcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // mistcoin: block index flags
    enum  
    {
