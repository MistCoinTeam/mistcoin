...
#ifndef H_mistcoin_SCRIPT
#define H_mistcoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CmistcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, mistcoin always counted CHECKMULTISIGs
