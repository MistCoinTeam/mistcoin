...
#ifndef _mistcoinRPC_H_
#define _mistcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // mistcoin is not connected
...
/**
 * mistcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
